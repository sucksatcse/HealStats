  ...
  staff: (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10 11a3.5 3.5 0 100-7 3.5 3.5 0 000 7zM3.5 17.5a6.5 6.5 0 0113 0"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M15.5 8.5l1.3 1.3 2.2-2.6"
      />
    </svg>
  ),
  sync: (
  ...
  analytics: (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3 17V3m0 14h14M6.5 14l3-3.5 2.5 2 3.5-4.5"
      />
    </svg>
  ),
  settings: (
  ...
  usersStat: (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M18 19v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2M10 9a4 4 0 100-8 4 4 0 000 8zM22 19v-2a4 4 0 00-3-3.87M16 1.13a4 4 0 010 7.75"
      />
    </svg>
  ),
  fileStat: (
  ...
  cloudStat: (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 12v5M9.5 14.5L12 12l2.5 2.5"
      />
    </svg>
  ),
  alertStat: (
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9 17A8 8 0 109 1a8 8 0 000 16zm0-11v3.5l2.5 2"
        />
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-slate-950 overflow-hidden font-[Work_Sans,system-ui,sans-serif] transition-colors">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {activeNav !== "ops-map" && (
          <main
            className={`flex-1 overflow-y-auto px-4 lg:px-8 py-6 space-y-6 transition-colors duration-500 ${
              emergency &&
              ![
                "staff",
                "patients",
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      stroke="currentColor"
                      strokeWidth={1.8}
                      className={`w-6 h-6 ${emergency ? "animate-pulse" : ""}`}
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  >
                    <span
                      className={`absolute top-0.5 left-0.5 w-6 h-6 rounded-full shadow-sm transition-transform ${
                        emergency
                ...
                {emergency ? (
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                      {SUMMARY.map(
                        ({ label, value, delta, up, note, icon, iconCls }) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <p className="text-sm font-medium text-slate-600 dark:text-slate-300 mt-1.5">
                                {label}
                              </p>
                              <p
                                className={`text-xs mt-0.5 ${
                        ...
                        <div className="flex items-start justify-between flex-wrap gap-3 mb-6">
                          <div>
                            ...
                            <div className="flex items-baseline gap-3 mt-1">
                              <span className="font-display text-2xl text-teal-950 dark:text-white">
                                {totalWeek.toLocaleString()}
                              </span>
                              <span className="text-xs text-slate-400 dark:text-slate-500">
                                total this week · avg {avgWeek}/day
                              </span>
                            </div>
                          </div>
                              ...
                              <div key={c.name}>
                                <div className="flex items-center justify-between mb-1.5">
                                  <div className="min-w-0">
                                    ...
                                    <span
                                      className={`flex items-center gap-1.5 text-[11px] font-medium mt-0.5 ${s.cls}`}
                                    >
                                      <span
