...
const Icon = {
  heart: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-full h-full">
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.8 6.6a5.5 5.5 0 00-7.8 0L12 7.6l-1-1a5.5 5.5 0 10-7.8 7.8l1 1L12 23l7.8-7.6 1-1a5.5 5.5 0 000-7.8z" />
    </svg>
  ),
  calendar: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-full h-full">
  ...
  clipboard: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-full h-full">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 4.5h6M9 4.5a2 2 0 00-2 2H6a2 2 0 00-2 2v11a2 2 0 002 2h12a2 2 0 002-2v-11a2 2 0 00-2-2h-1a2 2 0 00-2-2M8.5 13l2 2 4-4" />
    </svg>
  ),
  next: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-full h-full">
  ...
  warning: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-8 h-8">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4.5m0 3.5h.01M10.3 3.9L2.4 17.3a2 2 0 001.7 3h15.8a2 2 0 001.7-3L13.7 3.9a2 2 0 00-3.4 0z" />
    </svg>
  ),
  phone: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 16.5v3a2 2 0 01-2.2 2 19.8 19.8 0 01-8.6-3.1 19.5 19.5 0 01-6-6A19.8 19.8 0 011.1 3.7 2 2 0 013 1.5h3a2 2 0 012 1.7c.1 1 .4 1.9.7 2.8a2 2 0 01-.5 2.1L8.1 9.9a16 16 0 006 6l1.8-1.1a2 2 0 012.1-.5c.9.3 1.8.6 2.8.7a2 2 0 011.7 2z" />
    </svg>
  ),
};
  ...
  return (
    <div className="min-h-screen bg-teal-50 flex flex-col font-[Work_Sans,system-ui,sans-serif]">
      ...
      <header className="bg-white border-b border-teal-100">
        <div className="max-w-2xl mx-auto px-5 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-xl text-teal-900">Health<span className="text-teal-600">Stats</span></span>
          </div>
          ...
          <>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-slate-600 leading-relaxed max-w-md mx-auto">
                Type your Patient ID number to see your last visit and your next visit date.
              </p>
            </div>

            <div className="bg-white rounded-3xl border border-teal-100 shadow-sm p-6 sm:p-8">
              <label htmlFor="pid" className="block text-lg font-semibold text-teal-950 mb-3">
                Your Patient ID
              </label>
              <input
                id="pid"
              ...
              <p className="text-sm text-slate-400 mt-3 text-center">
                Your ID is on your clinic card. It looks like <span className="font-semibold text-slate-500">PT-00412</span>.
              </p>
              ...
              {notFound && (
                <div className="mt-5 flex items-start gap-3 bg-amber-50 border-2 border-amber-200 rounded-2xl px-4 py-4 text-amber-800">
                  ...
                  <div>
                    <p className="font-bold text-lg leading-tight">We could not find that ID</p>
                    <p className="text-base mt-1 leading-snug">Please check the number and try again, or ask a health worker for help.</p>
                  </div>
                </div>
              )}
            ...
            <p className="text-center text-sm text-slate-400 mt-6">
              Try: <button onClick={() => setId("PT-00412")} className="font-semibold text-teal-600 underline">PT-00412</button>
              {" · "}
              <button onClick={() => setId("PT-00358")} className="font-semibold text-teal-600 underline">PT-00358</button>
            </p>
          </>
        ) : (
          <>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <h1 className="font-display text-3xl text-teal-950 leading-tight">{record.name}</h1>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <SummaryCard
                ...
                label={record.status === "well" ? "You are well" : "Come back on"}
                value={record.nextVisit}
                sub={record.status === "well" ? "No follow-up needed right now." : "Please come to the clinic on this day."}
              />
            </div>

            {/* Help */}
            <div className="mt-6 bg-white rounded-2xl border border-teal-100 px-5 py-4 flex items-center gap-3">
              <span className="w-10 h-10 rounded-xl bg-teal-50 text-teal-600 flex items-center justify-center flex-shrink-0">{Icon.phone}</span>
              <div>
                <p className="font-semibold text-teal-950 text-base leading-tight">Need help?</p>
                <p className="text-sm text-slate-500">Call your clinic or ask a health worker.</p>
              </div>
            </div>
      ...
      <footer className="py-6 text-center">
        <p className="text-sm text-slate-400">Your information is private and safe.</p>
      </footer>
    </div>
  );
}
...
function SummaryCard({
  ...
  const tones = {
    ...
    violet: { icon: "bg-violet-100 text-violet-700",   edge: "border-l-violet-400" },
    amber:  { icon: "bg-amber-100 text-amber-700",     edge: "border-l-amber-400" },
    green:  { icon: "bg-emerald-100 text-emerald-700", edge: "border-l-emerald-400" },
  }[tone];

  return (
    <div className={`bg-white rounded-2xl border border-teal-100 border-l-8 ${tones.edge} p-5 sm:p-6 flex items-start gap-4`}>
      <span className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 p-3.5 ${tones.icon}`}>
        {icon}
      </span>
      <div className="min-w-0">
        <p className="text-base text-slate-500 font-medium">{label}</p>
        <p className="text-2xl sm:text-[28px] font-bold text-teal-950 leading-tight mt-0.5">{value}</p>
