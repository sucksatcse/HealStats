...
function ClinicIllustration() {
  return (
    <svg viewBox="0 0 420 320" fill="none" className="w-full max-w-sm mx-auto">
      {/* Ground */}
      <ellipse cx="210" cy="295" rx="180" ry="14" fill="#0f766e" opacity=".25" />
      ...
      {/* Windows */}
      <rect x="133" y="175" width="36" height="28" rx="3" fill="#0d9488" opacity=".7" />
      <rect x="251" y="175" width="36" height="28" rx="3" fill="#0d9488" opacity=".7" />
      <rect x="133" y="215" width="36" height="28" rx="3" fill="#0d9488" opacity=".5" />
      <rect x="251" y="215" width="36" height="28" rx="3" fill="#0d9488" opacity=".5" />

      {/* Solar panel on roof */}
      <rect x="150" y="128" width="120" height="16" rx="2" fill="#5eead4" opacity=".6" />
      <line x1="150" y1="136" x2="270" y2="136" stroke="#0d9488" strokeWidth="1" />
      <line x1="180" y1="128" x2="180" y2="144" stroke="#0d9488" strokeWidth="1" />
      <line x1="210" y1="128" x2="210" y2="144" stroke="#0d9488" strokeWidth="1" />
      <line x1="240" y1="128" x2="240" y2="144" stroke="#0d9488" strokeWidth="1" />

      {/* Tree left */}
      <rect x="70" y="220" width="10" height="60" rx="3" fill="#0f766e" opacity=".5" />
      <ellipse cx="75" cy="210" rx="26" ry="22" fill="#14b8a6" opacity=".55" />
      <ellipse cx="75" cy="200" rx="18" ry="16" fill="#5eead4" opacity=".45" />

      {/* Tree right */}
      <rect x="344" y="235" width="8" height="45" rx="3" fill="#0f766e" opacity=".5" />
      ...
      <path d="M340 100 Q350 90 360 100" stroke="#5eead4" strokeWidth="2.5" strokeLinecap="round" opacity=".8" />
      <path d="M333 93 Q350 78 367 93" stroke="#5eead4" strokeWidth="2" strokeLinecap="round" opacity=".55" />
      <path d="M326 86 Q350 65 374 86" stroke="#5eead4" strokeWidth="1.5" strokeLinecap="round" opacity=".3" />
      ...
      {/* Data lines / network */}
      <path d="M100 80 L175 60" stroke="#5eead4" strokeWidth="1" strokeDasharray="4 3" opacity=".4" />
      <path d="M175 60 L280 55" stroke="#5eead4" strokeWidth="1" strokeDasharray="4 3" opacity=".4" />
      <path d="M280 55 L350 107" stroke="#5eead4" strokeWidth="1" strokeDasharray="4 3" opacity=".4" />
      ...
      <rect x="162" y="64" width="26" height="10" rx="2" fill="#0d9488" opacity=".3" />
    </svg>
  );
}
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      <div className="relative lg:w-[52%] bg-teal-800 flex flex-col justify-between px-10 py-12 overflow-hidden min-h-[320px] lg:min-h-screen">
        ...
        <div className="relative z-10 flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-white/15 backdrop-blur-sm border border-white/20 flex items-center justify-center">
            <svg viewBox="0 0 20 20" fill="none" stroke="white" strokeWidth={1.9} className="w-4.5 h-4.5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M10 3.5C10 3.5 5.5 6.5 5.5 10.5a4.5 4.5 0 009 0C14.5 6.5 10 3.5 10 3.5z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M10 16.5v-3" />
            </svg>
          </div>
          <div>
            ...
            <span className="ml-2 text-[10px] font-bold uppercase tracking-widest text-teal-300 align-middle">Admin</span>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <div>
            <h1 className="font-display text-3xl lg:text-4xl text-white leading-tight mb-3">
              Manage every clinic,<br />
              from one dashboard.
            </h1>
            <p className="text-sm text-teal-200 leading-relaxed max-w-sm">
              The HealthStats admin portal gives district health officers a real-time view of sync status, patient volumes, and clinical activity — online or offline.
            </p>
          </div>
          ...
          <div className="flex items-center gap-6 pt-2 border-t border-white/10">
            {PANEL_STATS.map(({ value, label }) => (
              <div key={label}>
                ...
                <p className="text-[11px] text-teal-300 font-medium mt-0.5">{label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-between px-8 sm:px-12 lg:px-16 py-10 bg-white">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth={1.9} className="w-4 h-4 transition-transform group-hover:-translate-x-0.5">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full py-10">
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 mb-4 bg-teal-50 border border-teal-200 px-3 py-1.5 rounded-full">
              <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-3.5 h-3.5 text-teal-600">
                <rect x="2" y="6" width="10" height="7" rx="1.5" />
                <path strokeLinecap="round" d="M4.5 6V4.5a2.5 2.5 0 015 0V6" />
              </svg>
              <span className="text-xs font-bold text-teal-700 uppercase tracking-wider">Admin Portal</span>
            </div>
            <h2 className="font-display text-3xl text-teal-950 mb-1.5">Sign in to admin</h2>
          ...
          {forgotSent && (
            <div className="flex items-start gap-2.5 bg-teal-50 border border-teal-200 text-teal-700 text-sm rounded-2xl px-4 py-3 mb-5">
              ...
              Password reset link sent to <strong className="ml-1">{email}</strong>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="admin-password" className="block text-xs font-bold uppercase tracking-widest text-slate-500">
                  Password
                </label>
                <button
                  type="button"
              ...
              <div className="relative">
                ...
                >
                  {showPwd ? (
                    <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth={1.6} className="w-4 h-4">
                      <path strokeLinecap="round" d="M2 2l14 14M7.5 7.6A3 3 0 0110.4 10.5M4.2 4.3A8.5 8.5 0 001.5 9s2.7 5 7.5 5c1.5 0 2.8-.4 3.9-1.1M8.1 3.1C8.6 3 9 3 9.5 3c4.8 0 7.5 5 7.5 5a9.3 9.3 0 01-1.6 2.2" />
                    </svg>
                  ) : (
                    <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth={1.6} className="w-4 h-4">
                      <path strokeLinecap="round" d="M1.5 9s2.7-5 7.5-5 7.5 5 7.5 5-2.7 5-7.5 5-7.5-5-7.5-5z" />
            ...
            <p className="text-[11px] text-slate-400 leading-relaxed">
              Multi-factor authentication may be required for admin accounts. Check your authenticator app after submitting.
            </p>
              ...
              {loading ? (
                ...
                <>
                  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-4 h-4">
                    ...
                    <path strokeLinecap="round" d="M7 8h4M9.5 6.5l2 1.5-2 1.5" />
                  </svg>
                  Sign In to Admin
                </>
              )}
          ...
          <button className="w-full flex items-center justify-center gap-2.5 text-sm font-semibold text-slate-600 border border-slate-200 hover:border-teal-300 hover:text-teal-700 hover:bg-teal-50/50 py-3 rounded-xl transition-all">
            <svg viewBox="0 0 18 18" fill="none" className="w-4.5 h-4.5">
              <circle cx="9" cy="9" r="7.5" stroke="#4285F4" strokeWidth="1.5" />
              <path d="M9 4.5A4.5 4.5 0 019 13.5" stroke="#4285F4" strokeWidth="1.5" />
              <path d="M4.5 9h9" stroke="#4285F4" strokeWidth="1.5" strokeLinecap="round" />
              <path d="M5.2 6h7.6M5.2 12h7.6" stroke="#4285F4" strokeWidth="1.2" strokeLinecap="round" opacity=".5" />
            </svg>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3">
            {["Privacy", "Terms", "Support"].map((link) => (
              <a key={link} href="#" className="text-[11px] text-slate-400 hover:text-teal-600 transition-colors">
                {link}
              </a>
            ))}
          </div>
