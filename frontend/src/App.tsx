...
const LANDING = {
  en: {
    hero: {
      ...
      trust: [
        "WHO Digital Health certified",
        "Free for NGO and public health use",
        "30-second setup",
      ],
      offlineMode: "Offline mode active",
      recordsQueued: "14 records queued for sync",
    ...
    features: {
      ...
      cards: [
        {
          title: "Offline-First",
          desc: "Register patients, record visits, and pull full histories with zero connectivity. Everything syncs automatically the moment a signal returns — no record is ever lost between the char and the upazila hospital.",
        },
        {
          title: "AI Triage",
          desc: "Every intake is scored for urgency in seconds. On-device machine learning flags high-risk symptoms so overstretched health workers see the sickest patients first — even before the queue reaches a doctor.",
        },
        {
          title: "Disaster-Ready",
          desc: "Built for cyclone and monsoon-flood response. Switch to Emergency Mode to surface triage queues, active zones, and resource allocation across shelters — keeping care coordinated when infrastructure goes down.",
        },
      ],
    },
    howItWorks: {
      eyebrow: "How it works",
      h2: "Connect when you can. Work when you can't.",
      syncTime: "Sync time",
      syncValue: "<2 min",
      syncSub: "for 500 queued records",
      steps: [
        {
          step: "01",
        ...
        {
          step: "02",
          title: "Record visits without internet",
          body: "All data is stored locally. Clinicians enter patient data, diagnoses, and prescriptions exactly as they would online.",
        },
        {
          step: "03",
    ...
    testimonials: {
      ...
      items: [
        ...
        {
          quote:
            "The AI triage flags the sick children before they reach me. In a queue of eighty patients, that has changed how quickly we respond.",
          author: "Dr. Rafiqul Islam",
          role: "Medical Officer, Sunamganj Upazila Health Complex",
        },
      ],
    },
    cta: {
  ...
  bn: {
    hero: {
      ...
      trust: [
        "ডব্লিউএইচও ডিজিটাল স্বাস্থ্য সার্টিফাইড",
        "এনজিও ও জনস্বাস্থ্য ব্যবহারের জন্য বিনামূল্যে",
        "৩০ সেকেন্ডে সেটআপ",
      ],
      offlineMode: "অফলাইন মোড সক্রিয়",
      recordsQueued: "১৪টি রেকর্ড সিঙ্কের জন্য অপেক্ষায়",
    ...
    features: {
      ...
      cards: [
        {
          title: "অফলাইন-প্রথম",
          desc: "শূন্য সংযোগেও রোগী নিবন্ধন, ভিজিট রেকর্ড ও সম্পূর্ণ ইতিহাস দেখুন। সংকেত ফিরলেই সব স্বয়ংক্রিয়ভাবে সিঙ্ক হয় — চর থেকে উপজেলা হাসপাতাল পর্যন্ত কোনো রেকর্ড হারায় না।",
        },
        {
          title: "এআই ট্রায়াজ",
          desc: "প্রতিটি ভর্তিকে সেকেন্ডে জরুরিত্ব অনুযায়ী মূল্যায়ন করা হয়। অন-ডিভাইস মেশিন লার্নিং ঝুঁকিপূর্ণ লক্ষণ চিহ্নিত করে, যাতে ব্যস্ত স্বাস্থ্যকর্মীরা সবচেয়ে অসুস্থ রোগীকে আগে দেখতে পারেন।",
        },
        {
          title: "দুর্যোগ-প্রস্তুত",
          desc: "ঘূর্ণিঝড় ও বন্যার প্রতিক্রিয়ার জন্য তৈরি। জরুরি মোডে আশ্রয়কেন্দ্র জুড়ে ট্রায়াজ কিউ, সক্রিয় অঞ্চল ও সম্পদ বরাদ্দ দেখুন — অবকাঠামো বিপর্যস্ত হলেও সেবা সমন্বিত থাকে।",
        },
      ],
    },
    howItWorks: {
      eyebrow: "কীভাবে কাজ করে",
      h2: "পারলে সংযুক্ত হন। না পারলেও কাজ করুন।",
      syncTime: "সিঙ্কের সময়",
      syncValue: "<২ মিনিট",
      syncSub: "৫০০ কিউ রেকর্ডের জন্য",
      steps: [
        {
          step: "০১",
        ...
        {
          step: "০২",
          title: "ইন্টারনেট ছাড়াই ভিজিট রেকর্ড করুন",
          body: "সমস্ত ডেটা স্থানীয়ভাবে সংরক্ষিত হয়। চিকিৎসকরা ঠিক অনলাইনের মতোই রোগীর তথ্য, রোগ নির্ণয় ও ওষুধ লিখতে পারেন।",
        },
        {
          step: "০৩",
    ...
    testimonials: {
      ...
      items: [
        ...
        {
          quote:
            "এআই ট্রায়াজ অসুস্থ শিশুদের আমার কাছে পৌঁছানোর আগেই চিহ্নিত করে। আশিজনের লাইনে এটি আমাদের প্রতিক্রিয়া বদলে দিয়েছে।",
          author: "ডা. রফিকুল ইসলাম",
          role: "মেডিকেল অফিসার, সুনামগঞ্জ উপজেলা স্বাস্থ্য কমপ্লেক্স",
        },
      ],
    },
    cta: {
...
export default function App() {
  ...
  if (page === "loading-states")
    return <SkeletonStatesPage onBack={() => setPage("landing")} />
  if (page === "button-states")
    return <ButtonStatesPage onBack={() => setPage("landing")} />
  if (page === "record-saved")
    return <SuccessConfirmationPage onDone={() => setPage("landing")} />
  if (page === "sync-progress")
    return <SyncProgressPage onDone={() => setPage("landing")} />
  if (page === "design-system")
    return <StyleGuidePage onBack={() => setPage("landing")} />
  if (page === "system-states")
    return <EmptyStatesShowcase onBack={() => setPage("landing")} />
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {t.features.cards.map(({ title, desc }, i) => (
                ...
                >
                  ...
                  <h3 className="font-display text-xl text-teal-950 dark:text-white mb-2.5">
                    {title}
                  </h3>
        ...
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-teal-600 rounded-2xl p-5 shadow-xl text-white w-48">
                ...
                <p className="font-display text-3xl">
                  {t.howItWorks.syncValue}
                </p>
                <p className="text-xs text-teal-200 mt-1">
                  {t.howItWorks.syncSub}
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-5xl text-teal-950 dark:text-white leading-tight mb-6">
                {t.howItWorks.h2}
              </h2>
              <div className="space-y-6">
                {t.howItWorks.steps.map(({ step, title, body }) => (
                  <div key={step} className="flex gap-5">
                    ...
                    <div>
                      <h3 className="font-semibold text-teal-950 dark:text-white mb-1">
                        {title}
                      </h3>
                      <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                        {body}
        ...
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            <div className="text-center max-w-xl mx-auto mb-14">
              ...
              <h2 className="font-display text-4xl text-teal-950 dark:text-white">
                {t.testimonials.h2}
              </h2>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {t.testimonials.items.map(({ quote, author, role }) => (
                ...
                >
                  ...
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6 text-[15px]">
                    {quote}
                  </p>
