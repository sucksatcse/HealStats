    ...
    <StateShell role="status" ariaLive="polite">
      ...
      <div className="relative mb-7">
        <svg viewBox="0 0 200 160" className="w-56 h-44" aria-hidden="true">
          ...
          <path
            d="M60 70a26 26 0 0151-7 20 20 0 0125 19 18 18 0 01-4 35H62a24 24 0 01-2-47z"
            fill="#f0fdfa"
            stroke="#5eead4"
            strokeWidth="3"
            strokeDasharray="7 7"
      ...
      {onDismiss && (
        <button
          onClick={onDismiss}
          className="bg-teal-600 hover:bg-teal-700 text-white font-semibold text-sm px-6 py-3 rounded-xl shadow-sm transition-colors"
        >
          Continue working
        </button>
      )}
    ...
    <StateShell role="status" ariaLive="polite">
      ...
      <div className="relative mb-7">
        <svg viewBox="0 0 200 160" className="w-56 h-44" aria-hidden="true">
          ...
          <path
            d="M124 98a4 4 0 118 .5c0 2.5-4 3-4 5.5"
            fill="none"
            stroke="#5eead4"
            strokeWidth="3"
            strokeLinecap="round"
      ...
      <p className="text-slate-500 dark:text-slate-400 leading-relaxed mb-6">
        {query ? (
          ...
          <>
            No patients match your search. Try a different name, patient ID, or
            diagnosis.
          </>
        )}
      </p>
        ...
        <button className="flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white font-semibold text-sm px-5 py-3 rounded-xl shadow-sm transition-colors">
          ...
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M14 11a4 4 0 11-8 0 4 4 0 018 0zM10 7v8M6 11h8M3 18v-1a4 4 0 014-4"
            />
          </svg>
    ...
    <StateShell role="alert">
      ...
      <div className="relative mb-7">
        <svg viewBox="0 0 200 160" className="w-56 h-44" aria-hidden="true">
          ...
          {/* cloud */}
          <path
            d="M58 78a26 26 0 0151-7 20 20 0 0125 19 18 18 0 01-4 35H60a24 24 0 01-2-47z"
            fill="#fffbeb"
            stroke="#fcd34d"
            strokeWidth="3"
          />
